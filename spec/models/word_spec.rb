...
RSpec.describe Word, type: :model do
  ...
  context 'most common word shown first' do
    it 'retrieves the most common word first' do
      word_1 = Word.create(translated_word: "much", untranslated_word:"mucho", common_rank:98, user_id:1)
      word_2 = Word.create(translated_word: "of", untranslated_word:"de", common_rank:1, user_id:1)
      expect(Word.first).to eq(word_2)
    end
  end

  it "finds a searched word by english word" do
    word = Word.create(translated_word: "much", untranslated_word:"mucho", common_rank:98, user_id:1)
    @result = Word.find_by(translated_word: "much", user_id:1)
